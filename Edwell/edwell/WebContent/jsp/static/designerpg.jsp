...
<tr>
<a href="/edwell/jsp/static/designerview.jsp">
<h2>view details</h2>
</a>
</tr>
<tr>
<a href="/edwell/jsp/static/designerupdate.jsp">
...
<tr>
<a href="/edwell/jsp/static/upload.jsp">
<h2>upload pic</h2></a>
</tr>
...
<%-- </form>
String s="select picname from upload";
<div><img src="/edwell/null/<%rs.getString("picname");%>"></div>
 --%></body>
</html>