...
<div style="left:40%;top:15%;width:30%;height:50;position:absolute">
<form action="/edwell/jsp/static/updateu.jsp" method="post">
		...
		while(rs.next())
			{
				...
				<tr>
				<td>
				<input type="radio" name="rduserid" value="<%=rs.getString("userid")%>">
				<%=rs.getString("userid") %>
				</td>
