...
<form method="post" action="/edwell/Deletefeedback">
<table border=3>
<tr><th>Delete</th><th>Serial no.</th><th>Feedback</th></tr>
 ...
 try
 {
	 ...
	 <td>
	 <input type="checkbox" name="chkdesigner" value="<%=rs.getString("fdno") %>"></td><td><%=rs.getString("fdno") %></td>
	 <td> <%=rs.getString("fbdesc")%>
	 </td>
	 </tr>
