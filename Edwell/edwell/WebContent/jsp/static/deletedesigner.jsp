...
<b>DELETE DESIGNERS</b>
</div>

<div id="div1" name="div1" style="top: 30%;left: 2%;height: 40%;width: 55%;position: absolute;">
<form method="post" action="/edwell/DeleteDesigner">
<table border=3>
<tr><th>Delete</th><th>User Id</th></tr>
 <%  hs=request.getSession();
 String ui=(String)hs.getAttribute("userinfo");
 String strsql="Select id from logindetail where usertype=? ";
 ...
 try
 {
	 ...
	 while(rs.next())
	 { %>
	 <tr><td><input type="checkbox" name="chkdesigner" value="<%=rs.getString("id") %>"></td><td><%=rs.getString("id") %></td></tr>
